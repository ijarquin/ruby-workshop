...
Throughout the development process, I have made use of AI tools (Claude) as they were allowed to be used on the exercise to assist with various tasks. I have made use of AI for code generation especially around testing, I have explicitly described the scenarios
to test and the expected behaviour and let the AI deal with the boilerplate of the test implementation, this has allowed me to focus more on the test strategy and the scenarios to cover rather than the implementation details of the tests. Every time AI has been used it has been in small increments so we could easily review the code generated. Other situations where I have made use of AI was for functionalities I didn't think they were strictly required by the test but I thought they could enhance the user experience and help to improve some of the core web vitals, examples of this is the skeleton loading, the paginator component or the paginated response from the API.
